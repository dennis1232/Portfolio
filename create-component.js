// example to how its done you need to  write this line in the terminal 
// after --dir you need write where you want to create the folder and after the --name the name of the folder 
// this code create folder with jsx file scss file and js file to export the files
// -----------------------------------------------------------
//  node create-component --dir ./components --name "Header"
// -----------------------------------------------------------
...
try {
    ...
    const template = cmpType === 'function' ? componentFunctionTemplate : componentClassTemplate
